...
class Settings(BaseSettings):
    ...
    # neck — сколько отложить вниз: там проходит срез шеи. Больше — в аппликацию
    #   попадут плечи и одежда заказчика, чего на обложке быть не должно.
    head_neck_ratio: float = 0.45
