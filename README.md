...
пересадка головы и сведение стыка считаются локально — подробности в
`ml-service/README.md`. Стороннего платного сервиса не требуется: путь через
fal.ai остался в коде, но выключен настройкой и ключа не спрашивает.
